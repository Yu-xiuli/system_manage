...
export default [{
    ...
    {
        url: '/vue-admin-template/abcwejzpro/abcwejcoupon',
        type: 'get',
        response: config => {
    ...
    {
        url: '/vue-admin-template/ioptuproduct/ioptuefcouponupdate',
        type: 'post',
        response: config => {
            // const id = config.query.id
            const items = data.items
            ...
            data.items = products
            console.log(listOne, "8888888888888");
            return {
                code: 20000,
                data: {
                    message: "更新商品成功"
    ...
    },
    {
        ...
        response: config => {
            ...
            product.id = items[items.length - 1].id + 1
                // const id=this.items[length-1].id+1;
            console.log(product.id, "77777777");
